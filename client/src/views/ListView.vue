    ...
    <tbody>
      ...
      >
        <td>
          <a
            href="#"
            @click.prevent="handleClickOnDirs(bucket.id)"
        ...
        <td>
          <a
            href="#"
            @click.prevent="handleDeleteDirs(bucket.id)"
      ...
      >
        <td>
          <a
            href="#"
            @click.prevent="handleDownload(asset.url, asset.name)"
        ...
        <td>
          <a
            href="#"
            @click.prevent="handleDeleteAssets(asset.id)"
          ><i class="fas fa-trash-alt text-danger"></i></a>
        </td>
      </tr>
      <tr>
        <td class="d-sm-flex justify-content-start">
          ...
          > <i class="fas fa-plus fa-lg mr-2"></i>Adicionar
            Pasta</button>
          <div class="custom-file">
            ...
            <label
              ...
              for="customFile"
            ><i class="fas fa-upload mr-2"></i>Enviar</label>
          </div>
        </td>
      </tr>
    </tbody>
